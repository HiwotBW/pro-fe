...
//        savec
        ...
        contact_form.find('input,textarea').jqBootstrapValidation({
            ...
            submitSuccess: function($form, event) {
                ...
                var o              = $('[name="name"]', contact_form).val();
                var n             = $('[name="email"]', contact_form).val();
                var r           = $('[name="subject"]', contact_form).val();
                var message           = $('[name="message"]', contact_form).val();
                
                var formData = {
                		name : $('[name="name"]', contact_form).val(),
                        email : $('[name="email"]', contact_form).val(),
                        subject : $('[name="subject"]', contact_form).val(),
                        message : $('[name="message"]', contact_form).val()
                }
...
//                    dataType: 'json',
                    ...
                    success: function(result) {
                        if(result.sendstatus == 1) {
                            ajaxResponse.html(" Thank You " + formData.name + " we will contact you soon. ");
                            $form.fadeOut(500);
                        } else {
...
//        signinForm.find('input,textarea').jqBootstrapValidation({
//            preventSubmit: true,
//            submitError: function($form, event, errors) {
//                // additional error messages or events
//            },
...
//                event.preventDefault();
//
//                var submit            = $('submit', signinForm);
//                var ajaxResponse      = $('#contact-response');
//                var o              = $('[name="name"]', signinForm).val();
//                var n             = $('[name="email"]', signinForm).val();
//                var r           = $('[name="subject"]', contact_form).val();
//                var message           = $('[name="message"]', contact_form).val();
//                
//                var logindata = {
//                		email : $('[name="email"]', signinForm).val(),
//                        password : $('[name="password"]', signinForm).val(),
////                        subject : $('[name="subject"]', signinForm).val(),
////                        message : $('[name="message"]', contact_form).val()
//                }
//
//                $.ajax({
